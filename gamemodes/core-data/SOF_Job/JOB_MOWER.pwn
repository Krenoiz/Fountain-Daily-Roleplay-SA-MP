...
AddMowerVehicle()
{
    MowerVeh[0] = AddStaticVehicleEx(0, 2051.766, -1248.560, -23.312, 0.0000, 100, 100, VEHICLE_RESPAWN);
	MowerVeh[1] = AddStaticVehicleEx(0, 2049.542, -1248.549, -23.277, 0.0000, 100, 100, VEHICLE_RESPAWN);
	MowerVeh[2] = AddStaticVehicleEx(0, 2047.028, -1248.613, -23.297, 0.0000, 100, 100, VEHICLE_RESPAWN);
	MowerVeh[3] = AddStaticVehicleEx(0, 2044.255, -1248.675, -23.302, 0.0000, 100, 100, VEHICLE_RESPAWN);
}
