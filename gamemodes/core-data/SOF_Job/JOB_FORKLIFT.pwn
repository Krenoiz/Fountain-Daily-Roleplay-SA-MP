...
AddForVehicle()
{
	ForVeh[0] = AddStaticVehicleEx(530, 2758.74,-2385.79, 13.64, 177.14, 100, 100, VEHICLE_RESPAWN);
	ForVeh[1] = AddStaticVehicleEx(530, 2749.74,-2385.79, 13.64, 177.14, 100, 100, VEHICLE_RESPAWN);
	ForVeh[2] = AddStaticVehicleEx(530, 2752.74,-2385.79, 13.64, 177.14, 100, 100, VEHICLE_RESPAWN);
	ForVeh[3] = AddStaticVehicleEx(530, 2755.74,-2385.79, 13.64, 177.14, 100, 100, VEHICLE_RESPAWN);
}
