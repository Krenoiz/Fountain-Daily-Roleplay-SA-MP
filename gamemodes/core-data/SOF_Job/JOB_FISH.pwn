...
function FishTime(playerid)
{
	if(IsPlayerConnected(playerid) && pData[playerid][pInFish] == 1)
	{
		...
		{
		    Info(playerid, "Anda mendapatkan ikan tuna seberat %d lbs!", weight);
		    pData[playerid][pWorm] -= 1;
			pData[playerid][pFishTool] -= 1;
	        pData[playerid][pInFish] = 0;
		...
		{
		    Info(playerid, "Anda mendapatkan ikan tongkol seberat %d lbs!", weight);
		    pData[playerid][pWorm] -= 1;
			pData[playerid][pFishTool] -= 1;
	        pData[playerid][pInFish] = 0;
			pData[playerid][pFish] += weight;
		...
		{
		    Info(playerid, "Anda mendapatkan ikan kakap seberat %d lbs!", weight);
		    pData[playerid][pWorm] -= 1;
			pData[playerid][pFishTool] -= 1;
	        pData[playerid][pInFish] = 0;
			pData[playerid][pFish] += weight;
		...
		{
		    Info(playerid, "Anda mendapatkan ikan kembung seberat %d lbs!", weight);
		    pData[playerid][pWorm] -= 1;
			pData[playerid][pFishTool] -= 1;
	        pData[playerid][pInFish] = 0;
			pData[playerid][pFish] += weight;
		...
		{
		    Info(playerid, "Anda mendapatkan ikan makarel seberat %d lbs!", weight);
		    pData[playerid][pWorm] -= 1;
			pData[playerid][pFishTool] -= 1;
	        pData[playerid][pInFish] = 0;
			pData[playerid][pFish] += weight;
		...
		{
		    Info(playerid, "Anda mendapatkan ikan tenggiri seberat %d lbs!", weight);
		    pData[playerid][pWorm] -= 1;
			pData[playerid][pFishTool] -= 1;
	        pData[playerid][pInFish] = 0;
			pData[playerid][pFish] += weight;
		...
		{
		    Info(playerid, "Anda mendapatkan ikan blue marlin seberat %d lbs!", weight);
		    pData[playerid][pWorm] -= 1;
			pData[playerid][pFishTool] -= 1;
	        pData[playerid][pInFish] = 0;
			pData[playerid][pFish] += weight;
		...
		{
		    Info(playerid, "Anda mendapatkan ikan sail fish seberat %d lbs!", weight);
		    pData[playerid][pWorm] -= 1;
			pData[playerid][pFishTool] -= 1;
	        pData[playerid][pInFish] = 0;
			pData[playerid][pFish] += weight;
...
function FishTime2(playerid)
{
	if(IsPlayerConnected(playerid) && pData[playerid][pInFish] == 1)
	{
		...
		{
		    Info(playerid, "Ikan yang sangat besar! tetapi kapal anda tidak kuat menariknya.");
		    return 1;
		}
		else
		{
...
CMD:fish(playerid,params[])
{
	if(pData[playerid][pFishTool] > 0)
	{
	    if(pData[playerid][pWorm] > 0)
	    {
			...
			{
			    Error(playerid, "Anda harus berada di karnaval.");
			    return 1;
			}
		}
		else
...
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.0, 2843.6331,-1512.1372,11.3751)) return Error(playerid, "Kamu harus jual di tempat penjualan ikan.");
	if(pData[playerid][pFish] < 1)
		return Error(playerid, "You dont have fish.");

	if (pData[playerid][pJualIkanDelay] > 0)
		return Error(playerid, "Please wait %d minutes before selling again.", pData[playerid][pJualIkanDelay]);
		
	new fish = pData[playerid][pFish];
	new pay = fish * FishPrice;
	pData[playerid][pJualIkanDelay] = 15;
