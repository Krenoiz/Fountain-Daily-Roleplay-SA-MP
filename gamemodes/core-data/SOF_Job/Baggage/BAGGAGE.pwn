CreateJoinBaggagePoint()
{
   ...
   // CreateDynamicPickup(1239, 23, -2159.04, 640.36, 1052.38, -1, -1, -1, 50);
    ...
    //CreateDynamic3DTextLabel(strings, COLOR_YELLOW, -2159.04, 640.36, 1052.38, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); // Kurir
}
...
AddBaggageVehicle()
{
    BaggageVeh[0] = AddStaticVehicleEx(485, 2109.9346, -2234.4961, 13.2080, 45.9019, 100, 100, VEHICLE_RESPAWN);
	BaggageVeh[1] = AddStaticVehicleEx(485, 2107.4749, -2237.0952, 13.2043, 47.3460, 100, 100, VEHICLE_RESPAWN);
	BaggageVeh[2] = AddStaticVehicleEx(485, 2104.8237, -2239.7996, 13.2029, 46.3262, 100, 100, VEHICLE_RESPAWN);
	BaggageVeh[3] = AddStaticVehicleEx(485, 2102.3191, -2242.4695, 13.2049, 47.7862, 100, 100, VEHICLE_RESPAWN);
}
