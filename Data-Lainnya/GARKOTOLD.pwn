	...
	if(rows)
  	{
		...
		while(i < rows)
		{
			format(str, sizeof(str), "[ID: %d]\n{ffffff}%s"LG_E"\nTekan 'Y' Untuk Memasukkan / Mengambil", id, GetLocation(ppData[id][parkX], ppData[id][parkY], ppData[id][parkZ]));
			...
			ppData[id][parkPickup] = CreateDynamicPickup(19132, 23, ppData[id][parkX], ppData[id][parkY], ppData[id][parkZ], ppData[id][parkWorld],  ppData[id][parkInt], -1, 50);
