...
info_casino(playerid)
{
	...
	strcat(mes,"� ������� ������� 3 ������ ����:\n");
	strcat(mes,"1. � ������ ���� 3 ����� �� ������, ����� ������� ������ ���� �������������, �� ����������� ��.\n");
	strcat(mes,"��������� �����: (10%, 25%, 50%, 100%).\n");
	strcat(mes,"2. � ������ ��� ����� �� ������, ���� �� �� ���������, �� ����������� ��.\n");
	strcat(mes,"����� ���������: (25%, 50%, 75%, 150%).\n");
	strcat(mes,"3. ����� ����� ������� ��� ������, ������ ���, �� ����� ����� ����� 10$ �� ������ ��������\n");
	strcat(mes,"� ����� �� ��������� ������������� ����� ����������� ������, ����� �� �������� ���������\n");
	strcat(mes,"�����: (5% 10% 25% 50%) \n");
	strcat(mes,"C ���� ��� grod ������� ��� ����������\n");
	strcat(mes,"��� ������ ������(�.�)��������, � �� �� ������� �������. . .\n");
	ShowPlayerDialog(playerid, 0, 0, "{FF6F00}����������", mes, "��", "");
}
...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
    ...
    {
        PlayerPlaySound(playerid, 4203, 0.0, 0.0, 0.0);
    	ShowPlayerDialog(playerid,dialogid_bet,1,"��������� ������ ��� ����:","������ ������ ���� �� ����� 100 $\n� �� ����� 3000 $. ������� ����� ������..","�����","������");
    	return true;
    }
    if(playertextid == casino[playerid][9])
    {
        PlayerPlaySound(playerid, 4203, 0.0, 0.0, 0.0);
        if(InGame[playerid] == 1) return ShowPlayerDialog(playerid, 0, 0, "{FF6F00}����", "�� ����� ���� ������ ������ �����.", "��","");
    	new string[25];
    	Mode[playerid] += 1;
    	if(Mode[playerid] > 3)
    	{
    ...
    {
        if(Money_Win[playerid] == 0) return ShowPlayerDialog(playerid, 0, 0, "{FF6F00}����", "������� ������ ������ [BET]", "��","");
        new clicked;
        for(new t = 25; t-- != 13;)
        {
    ...
    {
    	PlayerPlaySound(playerid, 4203, 0.0, 0.0, 0.0);
        if(Money_Win[playerid] == 0) return ShowPlayerDialog(playerid, 0, 0, "{FF6F00}�������", "�� �� ���� �� ��������.", "��","");
        new string[15];
    ...
    {
        if(Money_Win[playerid] > 0) return ShowPlayerDialog(playerid, dialog_exit, 0, "{FFFFFF}��������������", "{FF0000}� ��� ������� ������,���� �� ������� ������,�� ��� ��������\n\
		{FFFF00}�� ������������� ������ �������� ����?", "Yes","No");
        PlayerPlaySound(playerid, 4203, 0.0, 0.0, 0.0);
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    if(dialogid == dialogid_bet)
	{
        ...
        if(strval(inputtext) < 100 || strval(inputtext) > 3000) return SendClientMessage(playerid,0xAFAFAFAA,"�������� ������");
        GivePlayerMoney(playerid, -strval(inputtext));
        Money_Win[playerid] += SetPVarInt(playerid,"w_m",strval(inputtext)/100);//100 - ��� ��� ���� ����� ��������� ������ ��� �������
        new string[25];
