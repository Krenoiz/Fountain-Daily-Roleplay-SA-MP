...
{
    if(!IsPlayerInRangeOfPoint(playerid, 3.0, 1991.3387,-1991.3845,13.5469) && !IsPlayerInRangeOfPoint(playerid, 3.0, 804.8683, -1358.5912, 13.5469) && !IsPlayerInRangeOfPoint(playerid, 3.0, 1693.9724, -2312.2305, 13.5469)) 
